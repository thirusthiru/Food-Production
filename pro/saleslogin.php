...
if(isset($plog))
{
$p1= "select * from sale_users where password = '$password' and username = '$username'";
$p2 = mysqli_query($con,$p1);
$n = mysqli_fetch_array($p2);
if($n['password'] == $password)
{
	$_SESSION['sales']['id'] = $n['id'];
   if($n['dat'] != $datt)
   {
   		mysqli_query($con,"update sale_users set created = '$datt'");
		header("Location: saleshome.php");
   }
   elseif($n['dat'] == $datt)
   {
    ...
    <table width="455" height="177" border="1" cellpadding="0" cellspacing="0" bordercolor="#0033FF">
      <tr>
        <th width="425" scope="col"><table width="424" height="156" border="0" cellpadding="0" cellspacing="0">
          ...
          <tr>
            <td height="41" colspan="2" align="center"><span class="style1">SALES'S EXECUTIVE LOGIN</span></td>
          </tr>
          <tr>
